...
# 280 s of the 600 s pool. The budget is wall-clock, so slower hardware simply
# does fewer playouts -- it can never overrun the limit.
    ...
    try:
        ...
        try:
            ...
            out = _fs.pimc_terminal(obs, _pimc_det, _pimc_policy,
                                    base_order[:4], time_budget=budget,
                                    samples=70, max_candidates=4)
