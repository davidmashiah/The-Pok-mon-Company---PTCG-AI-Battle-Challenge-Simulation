...
class AdvancedPolicy:
    ...
    def _score_option(self, option) -> float:
        ...
        # The upstream policy answers YES to EVERY yes/no question and always
        # elects to go first. Turn order is one binary that affects every game
        # and was never tested, so this variant elects to go SECOND and is
        # measured against the field. Everything else is unchanged.
