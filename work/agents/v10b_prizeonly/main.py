...
class AdvancedPolicy:
    ...
    def _score_active_choice(self, option, card: Pokemon | Card) -> float:
        ...
        # Prize economy: knocking out a Mega Evolution Pokemon ex gives the
        # opponent 3 prizes, a Makuhita gives 1. Evidence: across 9 replays of
        # the rank-1 agent (1275.3), 9 of 12 promotion disagreements were them
        # promoting a cheap 1-prize body where we promoted Mega Lucario ex.
        # Mega Brave costs FF, so below 2 Energy our 3-prize attacker is
        # standing in the Active Spot purely as a target.
