...
# DELIBERATELY STARVED control. Identical to v53_pimc except it gets a quarter
# of the search budget. If more playouts really do produce better play, v53 must
# beat this; if they read the same, the search is not converging on anything and
# raising the budget on Kaggle would buy nothing.
_PIMC_EPISODE_BUDGET_S = 22.0
_PIMC_PER_MOVE_CAP_S = 1.0
_pimc_spent = 0.0
_pimc_det = None
_pimc_last_turn = -999
