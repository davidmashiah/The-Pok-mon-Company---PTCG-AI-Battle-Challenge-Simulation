...
# v32's ORIGINAL list, kept deliberately: this variant isolates the damage-model
# fixes from the deck change in v37_combo. Same loader fix, so the constant, the
# bundled deck.csv and the deck actually played all agree. Verified in-engine: Marnie's Grimmsnarl ex
...
# 27/30 (155 turns).
DECK = [
    673, 673, 674, 674, 675, 675, 676, 676, 676, 677, 677, 677, 678,
    678, 678, 678, 1102, 1102, 1102, 1102, 1123, 1123, 1141, 1141, 1141, 1141,
    1142, 1142, 1142, 1142, 1152, 1152, 6, 1159, 1182, 1182, 1192, 1192, 1192,
    1192, 1227, 1227, 1227, 1227, 6, 6, 6, 6, 6, 6, 6, 6,
    6, 6, 6, 6, 6, 1182, 677, 1252,
]
