...
class AdvancedPolicy:
    ...
    def _score_play(self, option) -> float:
        ...
        if card.id == C.JUDGE:
            ...
            # Otherwise it is only a refuel that happens to cost them something:
            # take it when we clearly gain on the swap, or when we are hellbent.
            if opp_hand - my_hand >= 4: return 3150
            if my_hand <= 2: return 3050
            return -1
