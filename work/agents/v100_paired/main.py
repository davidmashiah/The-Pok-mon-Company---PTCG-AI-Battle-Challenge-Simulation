...
PLAYOUT_MIN_DETS = 8   # paired determinizations before it may override
PLAYOUT_MARGIN = 0.06        # paired edge required to overrule the heuristic
