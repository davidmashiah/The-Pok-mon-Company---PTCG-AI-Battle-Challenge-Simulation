...
def agent(obs_dict: dict) -> list[int]:
    ...
    # ABLATION: the forward lethal search is switched off here. The LB-950
    # ancestor this line was forked from (z_roman950) has no such search and
    # beats v43 head-to-head 0.5625 over 160 games, so the search is the prime
    # suspect for a regression we have been carrying since v3. If this ablation
    # beats v43, the search is costing us games; if it loses, the search is fine
    # and the regression is elsewhere.
    _lethal = None
    if _lethal:
