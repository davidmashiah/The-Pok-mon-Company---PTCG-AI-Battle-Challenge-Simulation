...
DECK = [
    ...
    6, 673, 673, 674, 674, 675, 675, 675, 676, 676, 676, 677, 677,
    677, 677, 678, 678, 678, 678, 1102, 1102, 1102, 1102, 1123, 1123, 1141,
    1141, 1141, 1141, 1142, 1142, 1142, 1142, 1152, 1152, 1159, 1182, 1182, 1192,
...
# Hill-climbed against a panel of REAL published agents (z_roman950 the LB-950
# baseline, w1_alakazam the 5th-place agent, w2_archaludon), weighted 0.45/0.35/
# 0.20. Nothing was adopted on a screen alone: each change also had to win a
# 540-game confirmation run on disjoint seeds -- the stage that killed 13 of 13
# false positives the last time this repo ran an optimiser (FINDINGS S11), and
# that rejected 8 of the 10 candidates that screened better here.
# Fitness 0.4589 -> 0.4969 over 33 rounds. Deck delta vs romanrozen v10:
# -1 Boss's Orders, +1 Lunatone.
