...
def _best_line(obs, ordered):
    ...
    AdvancedPolicy mutates module globals (plan / ability_used / pre_turn) via
    _plan_attack and _remember_lunatone_ability. Running it inside a simulation
    would corrupt the state backing the REAL decision, so snapshot/restore.
    """
