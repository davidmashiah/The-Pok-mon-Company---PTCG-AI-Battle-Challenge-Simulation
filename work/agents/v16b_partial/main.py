...
class AdvancedPolicy:
    ...
    def _score_option(self, option) -> float:
        ...
        # ctx 43 ACTIVATE: upstream answers YES to every yes/no question.
    ...
    def _score_card_choice(self, option) -> float:
        ...
        if self.context == SelectContext.TO_HAND:
            ...
            # Lunatone / Riolu / Makuhita. Agreement rose 0.301 -> 0.307.
    ...
    def _score_active_choice(self, option, card: Pokemon | Card) -> float:
        ...
        # ctx 3 SWITCH: 51 cases where same-archetype WINNERS promoted a cheap
        # 1-prize body (Solrock 15, Lunatone 13, Makuhita 6, Hariyama 4) and we
        # promoted Mega Lucario ex. A Mega ex knocked out gives 3 prizes.
