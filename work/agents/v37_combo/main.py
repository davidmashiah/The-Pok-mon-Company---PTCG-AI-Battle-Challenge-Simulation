...
# 3x Gravity Mountain (was 1), paying for it with -1 Fighting Gong and
# -1 Basic {F} Energy. Verified in-engine, not assumed: Marnie's Grimmsnarl ex
...
DECK = [
    ...
    1141, 1141, 1141, 1141, 1142, 1142, 1142,
